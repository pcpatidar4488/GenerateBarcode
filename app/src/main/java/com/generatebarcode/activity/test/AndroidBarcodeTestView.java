package com.generatebarcode.activity.test;
...
public class AndroidBarcodeTestView extends View
{
    static String data;
    static String barcodeType;
	public AndroidBarcodeTestView(Context context, String data, String barcodeType) {
	    super(context);
	    this.data=data;
	...
	protected void onDraw(Canvas canvas) {
		...
		try {
		    if (barcodeType.equals("CODE-128")){
                testCODE128(canvas);
            }else if (barcodeType.equals("CODE-39")){
                 testCODE39(canvas);
            }else if (barcodeType.equals("CODE-93")){
                testCODE93(canvas);
            }else if (barcodeType.equals("EAN-13")){
                testEAN13(canvas);
            }else if (barcodeType.equals("EAN-8")){
                testEAN8(canvas);
            }else  if (barcodeType.equals("CODABAR")){
                testCODABAR(canvas);
            }else  if (barcodeType.equals("UPC-E")){
                testUPCE(canvas);
            }else  if (barcodeType.equals("UPC-A")){
                testUPCA(canvas);
	...
	private static void testCODABAR(Canvas canvas) throws Exception
    {
        ...
        barcode.setBarcodeWidth(100.0f);
        ...
        barcode.setTextFont(new AndroidFont("Arial", Typeface.NORMAL, 18));
        // space between barcode and barcode encoding data
        barcode.setTextMargin(6);
        barcode.setTextColor(AndroidColor.black);
        
        // barcode bar code_type and background code_type in Android device
        ...
        */
      //  RectF bounds = new RectF(180, 40, 260, 300);
