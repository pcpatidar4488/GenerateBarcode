...
public class AndroidBarcodeView extends View {
    ...
    public AndroidBarcodeView(Context context, String input_data, String code_type) {
        super(context);
    ...
    private static void testEAN8(Canvas canvas) throws Exception {
        ...
        */
        ...
        barcode.setShowText(true);
        // barcode encoding data font style
        barcode.setTextFont(new AndroidFont("Arial", 0, 30));
        // space between barcode and barcode encoding data
        ...
        specify your barcode drawing area
	    */
        RectF bounds = new RectF(200, 30, 0, 0);
        barcode.drawBarcode(canvas, bounds);
    }
